**Policy**: - **Ballina RSL Sub-Branch – Internal: Investment
Portfolio**
...
- To achieve an investment return (based on market values and net of tax
...
| ASSET TYPE            | Protocol (Benchmark) % | Protocols (Target Range) % |
|:----------------------|:----------------------:|:--------------------------:|
